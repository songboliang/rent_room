!function (e, t) {
    ...
    try {
            ...
            function str(e, t) {
                ...
                switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
                    ...
                    case"object":
                        ...
                        if (rep && "object" == typeof rep) for (i = rep.length, r = 0; i > r; r += 1) "string" == typeof rep[r] && (n = rep[r], s = str(n, c), s && o.push(quote(n) + (gap ? ": " : ":") + s)); else for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (s = str(n, c), s && o.push(quote(n) + (gap ? ": " : ":") + s));
                        return s = 0 === o.length ? "{}" : gap ? "{\n" + gap + o.join(",\n" + gap) + "\n" + a + "}" : "{" + o.join(",") + "}", gap = a, s
                }
            }
        ...
        sd.para_default = {
            ...
            "image" !== sd.para.send_type && "ajax" !== sd.para.send_type && "beacon" !== sd.para.send_type && (sd.para.send_type = "image"), !sd.para.heatmap_url && sd.para.sdk_url && (sd.para.heatmap_url = sd.para.sdk_url.replace(/[^\/]+\.js[^\/]*$/, "heatmap.min.js"));
        ...
        logger.info = function () {
            ...
            var e = (FuncProto.bind, ArrayProto.forEach), t = ArrayProto.indexOf, r = Array.isArray, n = {},
                s = _.each = function (t, r, s) {
                    ...
                    if (e && t.forEach === e) t.forEach(r, s); else if (t.length === +t.length) {
                        for (var i = 0, o = t.length; o > i; i++) if (i in t && r.call(s, t[i], i, t) === n) return !1
                    } else for (var a in t) if (hasOwnProperty.call(t, a) && r.call(s, t[a], a, t) === n) return !1
                };
            _.logger = logger, _.extend = function (e) {
                ...
                var i = !1;
                return null == e ? i : t && e.indexOf === t ? -1 != e.indexOf(r) : (s(e, function (e) {
            ...
            var n, s, i, o = null, a = 0;
            r || (r = {});
            var c = function () {
                a = r.leading === !1 ? 0 : _.now(), o = null, i = e.apply(n, s), o || (n = s = null)
            };
            return function () {
                var u = _.now();
                a || r.leading !== !1 || (a = u);
                var l = t - (u - a);
                return n = this, s = arguments, 0 >= l || l > t ? (o && (clearTimeout(o), o = null), a = u, i = e.apply(n, s), o || (n = s = null)) : o || r.trailing === !1 || (o = setTimeout(c, l)), i
            }
            ...
            for (t = r = 0, i = e.length, n = 0; i > n; n++) {
                ...
                128 > o ? r++ : a = o > 127 && 2048 > o ? String.fromCharCode(o >> 6 | 192, 63 & o | 128) : String.fromCharCode(o >> 12 | 224, o >> 6 & 63 | 128, 63 & o | 128), null !== a && (r > t && (s += e.substring(t, r)), s += a, t = r = n + 1)
            }
            return r > t && (s += e.substring(t, e.length)), s
        }, _.base64Encode = function (e) {
            var t, r, n, s, i, o, a, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", l = 0,
                d = 0, p = "", f = [];
            if (!e) return e;
            e = _.utf8Encode(e);
            do t = e.charCodeAt(l++), r = e.charCodeAt(l++), n = e.charCodeAt(l++), c = t << 16 | r << 8 | n, s = c >> 18 & 63, i = c >> 12 & 63, o = c >> 6 & 63, a = 63 & c, f[d++] = u.charAt(s) + u.charAt(i) + u.charAt(o) + u.charAt(a); while (l < e.length);
            ...
            var e = function () {
                ...
                var r, n, s = navigator.userAgent, i = [], o = 0;
                for (r = 0; r < s.length; r++) n = s.charCodeAt(r), i.unshift(255 & n), i.length >= 4 && (o = t(o, i), i = []);
            ...
            function s(e) {
                e || (e = window.event), document.removeEventListener ? (document.removeEventListener("mouseup", s), document.removeEventListener("mousemove", n)) : document.detachEvent && (document.detachEvent("onmouseup", s), document.detachEvent("onmousemove", n)), e.stopPropagation ? e.stopPropagation() : e.cancelBubble = !0
            }

            var i = r(), o = t.clientX + i.x, a = t.clientY + i.y, c = e.offsetLeft, u = e.offsetTop, l = o - c,
                d = a - u;
            document.addEventListener ? (document.addEventListener("mousemove", n), document.addEventListener("mouseup", s)) : document.attachEvent && (document.attachEvent("onmousemove", n), document.attachEvent("onmouseup", s)), t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, t.preventDefault ? t.preventDefault() : t.returnValue = !1, e.style.bottom = "auto"
            ...
            t = t || window;
            var r = !1, n = !0, s = t.document, i = s.documentElement, o = s.addEventListener,
                a = o ? "addEventListener" : "attachEvent", c = o ? "removeEventListener" : "detachEvent",
                u = o ? "" : "on", l = function (n) {
                    ("readystatechange" != n.type || "complete" == s.readyState) && (("load" == n.type ? t : s)[c](u + n.type, l, !1), !r && (r = !0) && e.call(t, n.type || n))
                }, d = function () {
                    try {
                        i.doScroll("left")
                    } catch (e) {
            ...
            if ("complete" == s.readyState) e.call(t, "lazy"); else {
                if (!o && i.doScroll) {
                    try {
                        n = !t.frameElement
                    } catch (p) {
                ...
                s[a](u + "DOMContentLoaded", l, !1), s[a](u + "readystatechange", l, !1), t[a](u + "load", l, !1)
            }
        }, _.addEvent = function () {
            function e(t) {
            ...
            function t(t, r, n) {
                var s = function (s) {
                    if (s = s || e(window.event)) {
                        ...
                        var i, o, a = !0;
                        return "function" == typeof n && (i = n(s)), o = r.call(t, s), (!1 === i || !1 === o) && (a = !1), a
                    }
                };
                return s
            }
            ...
            get: function (e) {
                ...
                if (0 !== r) {
                    var u = new Date;
                    "s" === String(r).slice(-1) ? u.setTime(u.getTime() + 1e3 * Number(String(r).slice(0, -1))) : u.setTime(u.getTime() + 24 * r * 60 * 60 * 1e3), o = "; expires=" + u.toGMTString()
                }
                s && (a = "; secure"), document.cookie = e + "=" + encodeURIComponent(t) + o + "; path=/" + i + a
            }, remove: function (e, t) {
            ...
            function n(e, r) {
                for (var n = e.charAt(0), s = r.split("&"), i = [], o = {}, a = [], c = e.substring(1), u = 0, l = s.length; l > u; u++) if (i = s[u].match(/(.*?)=(.*)/), i || (i = [s[u], s[u], ""]), "" !== i[1].replace(/\s/g, "")) {
                    if (i[2] = t(i[2] || ""), c === i[1]) return i[2];
                    a = i[1].match(/(.*)\[([0-9]+)\]/), a ? (o[a[1]] = o[a[1]] || [], o[a[1]][a[2]] = i[2]) : o[i[1]] = i[2]
                }
                return n === e ? o : o[c]
            }
            ...
            return function (t, s) {
                ...
                if (t = t.toString(), i = s.match(/^mailto:([^\/].+)/)) o.protocol = "mailto", o.email = i[1]; else {
                    if ((i = s.match(/(.*?)\/#\!(.*)/)) && (s = i[1] + i[2]), (i = s.match(/(.*?)#(.*)/)) && (o.hash = i[2], s = i[1]), o.hash && t.match(/^#/)) return n(t, o.hash);
                    if ((i = s.match(/(.*?)\?(.*)/)) && (o.query = i[2], s = i[1]), o.query && t.match(/^\?/)) return n(t, o.query);
                    if ((i = s.match(/(.*?)\:?\/\/(.*)/)) && (o.protocol = i[1].toLowerCase(), s = i[2]), (i = s.match(/(.*?)(\/.*)/)) && (o.path = i[2], s = i[1]), o.path = (o.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""), t.match(/^[\-0-9]+$/) && (t = t.replace(/^([^\/])/, "/$1")), t.match(/^\//)) return r(t, o.path.substring(1));
                    if (i = r("/-1", o.path.substring(1)), i && (i = i.match(/(.*?)\.(.*)/)) && (o.file = i[0], o.filename = i[1], o.fileext = i[2]), (i = s.match(/(.*)\:([0-9]+)$/)) && (o.port = i[2], s = i[1]), (i = s.match(/(.*?)@(.*)/)) && (o.auth = i[1], s = i[2]), o.auth && (i = o.auth.match(/(.*)\:(.*)/), o.user = i ? i[1] : o.auth, o.pass = i ? i[2] : void 0), o.hostname = s.toLowerCase(), "." === t.charAt(0)) return r(t, o.hostname);
            ...
            if (document && "string" == typeof document.referrer) {
                if (0 === document.referrer.indexOf("http")) {
                    var t = _.url("domain", document.referrer), r = _.url("?", document.referrer), n = null;
            ...
            initPage: function () {
                var e = _.getReferrer(), t = e ? _.url("hostname", e) : e, r = e ? _.url("domain", e) : e,
                    n = location.href, s = n ? _.url("hostname", n) : n, i = n ? _.url("domain", n) : n;
                ...
                for (var i in r) -1 !== (" " + source_channel_standard + " ").indexOf(" " + i + " ") ? n[e + i] = r[i] : s[t + i] = r[i];
            ...
            if (e = JSON.stringify(e), logger.info(n), this.requestData = {
                ...
                if (/sensors-verify/.test(navigator.userAgent)) {
                    ...
                    if (i && i[0] && "string" == typeof i[1] && 2 === i[1].split("?").length) {
                        ...
                        var o = null, a = null;
                        try {
                            o = _.url("hostname", sd.para.server_url), a = _.url("?project", sd.para.server_url) || "default"
                        } catch (c) {
                        }
                        o && o === i[0] && a && a === i[1] ? (s = document.createElement("iframe"), s.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({server_url: sd.para.server_url}, n)))), document.documentElement.appendChild(s), s.parentNode.removeChild(s), s = null, "function" == typeof r && r()) : this.prepareServerUrl()
                    }
        ...
        var saNewUser = {
            checkIsAddSign: function (e) {
                ...
                var i = _.info.campaignParamsStandard("$latest_", "_latest_"), o = i.$utms, a = i.otherUtms;
                _.isEmptyObject(o) || sd.register(o), _.isEmptyObject(a) || sd.register(a)
            }
        }, saEvent = {};
        saEvent.checkOption = {
        ...
        var store = sd.store = {
            ...
            isReady: function (e) {
                ...
                for (var s in r) -1 !== (" " + source_channel_standard + " ").indexOf(" " + s + " ") ? n["$" + s] = r[s] : n[s] = r[s];
        ...
        var heatmap = {
            getDomIndex: function (e) {
                ...
                return _.isObject(sd.para.heatmap) && "default" === sd.para.heatmap.clickmap ? _.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url() ? !1 : ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", void ("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function (t) {
                    ...
                    if ("body" === s.toLowerCase() || "html" === s.toLowerCase()) return !1;
                    if (!n || !n.parentNode || !n.parentNode.children) return !1;
                    if (parent_ele = n.parentNode, "a" === s || "button" === s || "input" === s || "textarea" === s) e.start(r, n, s); else if ("button" === parent_ele.tagName.toLowerCase() || "a" === parent_ele.tagName.toLowerCase()) e.start(r, parent_ele, n.parentNode.tagName.toLowerCase()); else if ("area" === s && "map" === parent_ele.tagName.toLowerCase() && _.ry(parent_ele).prev().tagName && "img" === _.ry(parent_ele).prev().tagName.toLowerCase()) e.start(r, _.ry(parent_ele).prev(), _.ry(parent_ele).prev().tagName.toLowerCase()); else {
