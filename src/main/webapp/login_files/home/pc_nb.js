!function (n) {
    ...
    !function (n) {
        ...
        function a(n) {
            ...
            if (e && !f(n, F)) {
                ...
                var a = [];
                $(t, function (t, r) {
                    var o, u, c = A(t), f = E(c.mod, n);
                    f && !L[f] ? (c.res && (u = {
                        id: t,
                        mod: f,
                        res: c.res
                    }, D[f] = 1, e.depPMs.push(f), e.depRs.push(u)), (o = e.depMkv[f]) || (o = {
                        id: c.mod,
                        absId: f,
                        hard: i > r
                ...
                if (!r && i.state === T) {
                    ...
                    if ($(i.factoryDeps, function (n) {
                        ...
                        try {
                            ...
                            null != c && (i.exports = c), i.invokeFactory = null, delete D[e]
                        } catch (n) {
        ...
        function h(n, e) {
            ...
            if (!O[n]) {
                var a = A(n), o = {id: n, state: F};
                O[n] = o, t.fromText = function (n, e) {
                    D[n] = 1, new Function(e)(), m(n)
                }, i(v(a.mod))
            }
        }
        ...
        function x() {
            ...
            }), K.sort(B), V = b(H.urlArgs, 1), W = b(H.noRequests), $(W, function (n) {
                var e = n.v, t = {};
        ...
        function q(n) {
            function e(e, r) {
                if ("string" == typeof e) return t[e] || (t[e] = g(E(e, n))), t[e];
                if (e instanceof Array) {
                    var i = [], a = [], o = [];
                    $(e, function (e, t) {
                        var r = A(e), u = E(r.mod, n);
                        a.push(u), D[u] = 1, r.res ? (i.push(u), o[t] = null) : o[t] = u
                    });
                    var u = {};
                    $(a, function (n) {
                        var e;
        ...
        var O = {}, D = {}, j = 1, F = 2, T = 3, z = 4, N = q();
        e.version = "1.8.6", e.loader = "esl", e.toUrl = N.toUrl;
        var P;
        t.amd = {};
        var _ = {}, L = {require: e, exports: 1, module: 1}, C = [], G = {},
    ...
    require.config({
        'baseUrl': '//sgoutong.baidu.com/embed/1546850358/asset/',
        'paths': {'cl': 'common/css'},
        ...
        return exports.messageHandler = function (e, n) {
            ...
            if (exports.emit("trysendmsg"), !e.isConnected()) return exports.emit("sendfail", n), !1; else return t.encode(n, function (t) {
        ...
        return exports.canUseWs = function (e, i, o, r, s, a, c) {
            ...
            return function (e) {
                ...
                if (s.set("sn", e.n_sn), !e.status || 2 === e.status) exports.emit("response", o || e.method, e.body || e), n(e.body || e); else {
                    if (void 0 === r) r = !0;
            ...
            var m = c.data || {};
            if (exports.emit("request", a, m), m.v = i.bid, m.s = i.siteid, m.e = i.eid, m.dev = i.platform, m.auth = o.get(), "chat/st" === a && o.get("code_token")) m.code_token = o.get("code_token");
        ...
        function t() {
            if (!v.connected) if (v.csonline) if (!v.csonline || v.online) v.connected = !0, exports.emit("connected", {sid: v.sid}), g.each(v.msgPool, function (e) {
        ...
        function i(e, t) {
            if (!e.pickType) v.sid = e.sid, v.to = e.uid, v.authType = e.authtype, v.csonline = !0, v.ttype = e.ttype;
            if (t) h.sinfo = e.sinfo && m.json.parse(e.sinfo) || {}
        }

        function o() {
            k = {ifIR: !1, count: 0, id: null}
        }
        ...
        function a(e) {
            if (L = 0, A) A = !1, exports.emit("reconnect");
        ...
        function c(e) {
            if (++L > R && !A) A = !0, exports.emit("offline")
        }
        ...
        var f, m = require("im-lib"), p = m.Emitter, g = m.lang, h = require("./config"), b = require("./net"),
            v = {connected: !1, stopPick: !1, csonline: !1, msgPool: [], presend: {sending: !1, content: ""}},
            y = {INVITE: 18, ACCEPT: 20, BYE: 28}, T = {OVER: 4, TAKE_OVER: 3, TRANSFER: 6, RECEIVE: 2}, I = "blocked",
            S = "auto", w = {SUCCESS: 0, FAILURE: 1}, E = {QUEUEING: 2, TALKING: 4}, x = 10,
            k = {ifIR: !1, count: 1, id: null}, C = {CSR: 0, GROUP: 1, IR: 4},
            P = {READY: 0, BUSY: 1, LEAVE: 2, UNLOGIN: 3}, N = {TRANSFER: 0, CONVERSATION: 1},
            O = {COUNT: 0, LIST: 1, MSG_SYNC: 0, END_TIME: 0, PAGE: 20, DEFAULT: 5, DELAY: 2e3}, _ = [], exports = {};
        p.mixin(exports), b.on("auth invalid", function () {
            v.stopPick = !0
        }), exports.pickHandler = {}, exports.pickHandler[100] = function (e) {
            if (e.op === y.ACCEPT) if (e.st === w.SUCCESS) O.END_TIME = e.systime || 0, v.sid = e.sid, v.to = e.uid, v.authType = e.authtype, v.csonline = !0, v.online = !0, h.sinfo = e.sinfo && m.json.parse(e.sinfo) || {}, exports.fetchOfflineMsg(), O.MSG_SYNC = e.systime || 0; else exports.bye();
            if (e.op === y.BYE) if (e.st === w.SUCCESS) {
                var t = v.options || {};
                if ("talk to other" === e.reason) v.stopPick = !1, t.invited = 0, t.tid = h.tid, t.ttype = 1, t.sid = "", t.from = 5, exports.connect(t.ttype, t, !1)
            } else exports.emit("invitefail");
            if (e.op === y.INVITE) {
                if (O.END_TIME = e.systime || 0, "queue" === e.reason) return;
                if (e.ttype === C.IR) k.ifIR = !0, k.id = e.uid, exports.emit("currentIR");
                if ("re_invite" === e.reason && h.status === E.QUEUEING) return void exports.emit("queueing");
                if ("re_invite" === e.reason) {
                    if (h.sinfo = e.sinfo && m.json.parse(e.sinfo) || {}, v.sid = e.sid, v.to = e.uid, v.authType = e.authtype, v.tid = h.tid || "", v.ttype = e.ttype, v.csonline = !0, v.online = !0, h.syncSessionHistory) exports.fetchSessionMessage();
                    return void exports.fetchOfflineMsg()
                }
                if (e.st === w.SUCCESS) v.sid = e.sid, v.to = e.uid, v.authType = e.authtype, v.csonline = !0, v.ttype = e.ttype, h.sinfo = e.sinfo && m.json.parse(e.sinfo) || {}; else {
                    var n = m.json.parse(e.adata || "{}");
                    return v.to = n.uid || "-1", v.authType = e.authtype, v.csonline = !1, exports.emit("csoffline"), void exports.fetchOfflineMsg()
                }
                exports.fetchOfflineMsg()
            }
        }, exports.pickHandler[101] = function (t) {
            if (t.msgHandlerType = t.msgHandlerType || "", t.opr === T.OVER) if (t.reason && -1 !== t.reason.indexOf(I)) exports.emit("visitorblock", t), e(); else if (t.reason && -1 !== t.reason.indexOf(S)) exports.emit("autoendtalk", t), e(); else n("forceover"); else if (t.opr === T.TAKE_OVER) if (i(t, !0), k.ifIR) o(), exports.emit("fininshIR", {type: "invite"}); else exports.emit("updateNewCSR", h.sinfo); else if (t.opr === T.TRANSFER) if (i(t, !0), k.ifIR) o(), exports.emit("fininshIR", {type: "online"}); else exports.emit("updateNewCSR", h.sinfo); else if (t.opr === T.RECEIVE) {
                var r = t.detail || {};
            ...
            if (v.connected) {
                if (exports.emit("message", e), k.ifIR && e.from === k.id && k.count) if (++k.count >= 5) exports.emit("showMsgRemind", k.count), k.count = 0
            } else v.msgPool.push(e)
        }, exports.pickHandler[104] = function (e) {
            if (h.status = e.status, e.status === E.QUEUEING) v.sid = e.sid, v.queueing = !0, exports.emit("queueing");
            ...
            if (e.type === O.COUNT) {
                ...
                t = _.concat(t), _ = [], t = r(t), g.each(t, function (e, t) {
                    e.msgHandlerType = "insertBefore", exports.emit("message", e)
                }), exports.fetchHisFinish(!0, e)
            }
        }, exports.pickHandler[106] = function (e) {
            v.sid = e.sid, v.to = e.uid, v.authType = e.authtype, v.csonline = !0, h.sinfo = e.sinfo && m.json.parse(e.sinfo) || {}, exports.fetchOfflineMsg()
            ...
            if (k.ifIR && e.status === P.READY) exports.emit("csonline", e, "IR"); else if (!v.connected && e.status === P.READY) exports.emit("csonline", e, "OFFLINE_MSG")
            ...
            t = t || {};
            var n = h.offlineMsgGetType || 0, i = n ? "" : v.sid, o = n ? "-1" : v.tid, r = n ? h.bid : v.to, s = {
                sid: i,
                tid: o,
            ...
            var r = m.json.stringify({tag: 1, type: 2, userId: n - 0, subId: i - 0, bid: h.bid}), s = {
                sid: v.sid,
                tid: v.tid,
        ...
        return exports.wsPickSucc = function (e) {
            ...
            c(e)
        }, exports.pick = l, exports.connect = function (e, t, i, o, r) {
            o = o || {}, v.tid = o.tid || "", v.options = o;
            var s = {
                op: 0,
                sid: o.sid || "",
                tid: v.tid,
            ...
            b.chat(s, function (e) {
                if (!1 !== r) if (v.stopPick = !1, t.usingWs) exports.wsPickSucc(e), exports.wsPick(); else l()
            }, function () {
                n("connect")
            })
            ...
            if (n = n || {}, e = e || {}, h.sinfo = e.sinfo && m.json.parse(e.sinfo) || {}, v.sid = e.sid, v.to = n.tid, v.authType = e.authtype, v.csonline = !0, v.online = !0, v.tid = e.tid || "", v.options = n, v.stopPick = !1, h.syncSessionHistory) exports.fetchSessionMessage();
            t(), l()
        }, exports.queue = function (e, t) {
            t = t || {}, e = e || {}, h.sinfo = e.sinfo && m.json.parse(e.sinfo) || {}, v.sid = e.sid, v.to = e.uid, v.authType = e.authtype, v.csonline = !0, v.tid = e.tid || "", v.options = t, v.stopPick = !1, exports.emit("queueing"), l()
        }, exports.preSend = function (e, t) {
            if (t.content && !0 !== v.presend.sending && t.content !== v.presend.content) {
                t.mtype = 0, t.to = v.to, t.time = (new Date).getTime(), t.rtype = v.ttype;
                var n = {sid: v.sid || "", tid: v.to, type: e.PUSH_TYPE_PRE_SEND, tid_authtype: v.authType, param: t};
                b.push(n, function (e) {
                    v.presend.sending = !1
                }, function (e) {
                    v.presend.sending = !1
                }), v.presend.sending = !0, v.presend.content = t.content
            }
        }, exports.send = function (e, t, n, i) {
            t.from = h.bid, t.to = v.to, t.time = (new Date).getTime(), t.rtype = v.ttype;
            var o = {
                sid: v.sid || "",
                tid: v.to,
            ...
            if (h.syncFetchOfflineMsg) {
                var n = {
                    ...
                    type: e.PUSH_TYPE_FETCH_HISTORY,
                    tid_authtype: h.authType,
                    param: {type: O.COUNT, from: v.to, from_authtype: v.authType}
                };
                b.push(n, null, exports.fetchHisFinish), f = setTimeout(function () {
                    t()
                }, O.DELAY)
            } else t()
        }, exports
        ...
        function i(n, i) {
            ...
            var s = {mtype: d, content: {type: u, bcsName: o}}, l = require("../main");
            a.upload(r, n.form || n.path, function () {
                s.content.status = 0, i(s), l.emit("imgsendsuccess", {bcsName: o, id: n.mid, status: "success"})
            }, function () {
                s.content.status = 1, i(s), l.emit("imgsendfail", {bcsName: o, id: n.id, status: "fail"})
            })
        }
        ...
        function e(e, t) {
            ...
            for (var i = n.getElementsByTagName("img"), o = i.length; o; o--) {
                ...
                if (r.getAttribute("data-bcsName")) {
                    ...
                    a.setAttribute("data-bcsName", r.getAttribute("data-bcsName")), a.setAttribute("data-uploaded", r.getAttribute("data-uploaded")), a.id = r.id, r.id = "";
                    var c = r.parentNode;
                    c.insertBefore(a, r), c.removeChild(r)
                }
            }
            t({mtype: s, content: n.innerHTML.replace(/\r|\n/gi, "") || ""})
        }
        ...
        function i(e, t) {
            var i = (require("../chat"), n(e.content)), s = e.from === o.bid ? 0 : 1;
            t({type: r, role: s, time: 1e3 * e.time, text: i || ""})
        }

        var o = (require("../chat"), require("../config")), r = "text", s = 0, exports = {};
        return exports.encoder = {}, exports.encoder[r] = e, exports.decoder = {}, exports.decoder[s] = i, exports
        ...
        return exports.generateHead = function (e, t, n) {
            ...
            o.msgid = s.msgid, o.method = "/" + t, o.header = {cookie: exports.generateCookie()};
        ...
        return exports.pickSuccess = function (e, t) {
            ...
            t.poll(!0, function (e) {
                if (!exports.checkAuthResult(e, n, i, o)) exports.getAuthResult(n, i, o)
            }, i)
        ...
        exports.componentIsShow = {icon: 0, toolbar: 0}, exports.smartInvite = {expGroup: "", text: "", isUse: 0};
        var u = 1;
        return exports.init = function (e, t, n) {
            var i = e.getServer(), o = i.siteObj;
            s.eid = o.eid, s.siteid = o.siteId, s.platform = o.platform, n.bid = t.init(o.siteId, o.bid || n.bid, o.session), s.bid = n.bid, s.logRoot = e.staticDomain, s.startTime = i.startTime
            ...
            var o = {brgeyemid: "m2005", url: document.URL, referrer: document.referrer, bclid: n.get("BCLID")};
            i && (o.type = i), exports.sendLog(t(), o)
            ...
            var e = function () {
                var e = a.pushMsg;
                if (a.pushMsg = 0, e > 0) exports.sendLog(t(), {num: e, brgeyemid: "m2003"});
                setTimeout(arguments.callee, 5e3)
            };
            setTimeout(e, 5e3)
            ...
            i("m2010"), exports.sendLog(t(), {cncttype: "startSite", uuid: e("enterUUID"), brgeyemid: "m2010"})
        ...
        return exports.renderHtml = function (e, t, n, i, o, r) {
            ...
            if (0 != +n.width && 0 != +n.height) exports.renderHtml(), e.init()
        }, exports
        ...
        return exports.clickIcon = function (t, n, i, o, r) {
            ...
            e.accept(0, n), t.hide(["nb_invite_wrap"])
        ...
        return exports.renderHtml = function (e, t, n, i, o, r, s) {
            var a = t.getWrap(), c = n.getInviteStyle(), u = i.template(o, c);
            if (1 === s.isShowWithToolbar) e.appendHTML(u, document.getElementById("nb_toolbar_wrap")); else e.appendHTML(u, a);
            r.process()
        }, exports.init = function (e) {
        ...
        return exports.inviteWindowGuard = function (e, t, n, i, o) {
            ...
            if (e.isAutoInvite()) {
                ...
                if (+r.startPage === i.ONLY_STARTPAGE) {
                    ...
                    if (!s) exports.delayToShow(o); else if (s === location.href) exports.delayToShow(o); else if (document.referrer) {
        ...
        function e(e, i) {
            ...
            var T = i.charset || m, I = function (e) {
                i.onsuccess && i.onsuccess(e), n(c), o(v)
            }, S = function () {
                i.onfail && i.onfail(), n(c), o(v)
            }, w = s({url: e + t(e, y, b, v), charset: T, id: a});
            if (d[a] = u[a] = function () {
                try {
        ...
        var e = require("./net/ajax"), t = require("./net/jsonp"), n = require("./net/img"),
            i = "http://p.qiao.baidu.com", exports = {};
    ...
    }), define("embed/invite/mobile/smartyInvite", ["require", "../../mobilelite/lib/ajax"], function (require) {
        function e() {
            if ("" === document.referrer) return !1;
            if (d = document.referrer, -1 !== d.indexOf("baidu.php?")) return !0; else return !1
        }
        ...
        function n(e, t) {
            ...
            if (t) n.sublink = t;
            var i = {
                data: n, type: "jsonp", onsuccess: function (e) {
                    if (0 === e.status) if ("" === e.value) g = []; else g = e.value.split("");
        ...
        function r(e) {
            ...
            S = 0;
            for (var n = 0; n < t.length; n++) if (1 === t[n].enable) if (S++, "onlineConsult" === t[n].type) w = S - 1;
            return "1" === e.toolbar.enable && -1 !== w
        }

        function s(e) {
            if (1 === e.isFixedPosition) return -1 === e.position.indexOf("top");
            var t = document.documentElement.clientWidth, n = document.documentElement.clientHeight,
                i = t * e.width * .01, o = n * e.height * .01;
            if (1 === e.skinIndex || 3 === e.skinIndex || 4 === e.skinIndex) o = i;
            return e.marginTop > n / 2 - .5 * o
        }

        function a(e) {
            if (1 === e.isFixedPosition) return -1 !== e.position.indexOf("right"); else return e.marginLeft > window.innerWidth / 2
        }
        ...
        function u(e) {
            var t = e.seekIcon;
            b = "";
            var n = 1 * t.marginLeft, i = 1 * t.marginTop, o = document.documentElement.clientWidth,
                r = document.documentElement.clientHeight, s = o * t.width * .01, a = r * t.height * .01, u = "left",
                d = "top";
            if (1 === t.skinIndex || 3 === t.skinIndex || 4 === t.skinIndex) a = s;
            if (1 === t.isFixedPosition) {
                if (b = t.position) var l = b.split("-");
                if ("center" === l[1]) n = 5, i = .5 * a, I = l[0] + ":5px;top:50%;margin-top:-" + i + "px;", E = l[0] + ":" + (s / 2 - 16) + "px"; else n = 5, i = 5 + a, u = l[0], d = l[1], I = c(n, i, u, d), E = u + ":" + (s / 2 - 16) + "px"
            } else {
                var f = n + s / 2;
                if (s + n > o) n = 20, u = "right"; else if (f < .55 * o) u = "left"; else n = o - n - s, u = "right";
                if (a + i > r) i = a + 20, d = "bottom"; else if (i > .5 * r - .5 * a) d = "bottom", i = r - i; else i = 1 * t.marginTop + a;
                if (I = c(n, i, u, d), E = u + ":" + (s / 2 - 16) + "px;", f > .45 * o && f < .55 * o) b = "center", n += .5 * s, I = c(n, i, u, d), E = "left:50%;margin-left:-16px"
            }
        }

        var exports = {}, d = "", l = "", f = "", m = 0, p = require("../../mobilelite/lib/ajax"), g = [], h = 0,
            b = "", v = "",
            y = ['\u60a8\u662f\u60f3\u54a8\u8be2"point"\u5417\uff1f', '\u60a8\u662f\u5bf9"point"\u611f\u5174\u8da3\u5417\uff1f', '\u6b22\u8fce\u54a8\u8be2"point"'],
            T = ["\u6b22\u8fce\u60a8\uff0c\u6709\u4ec0\u4e48\u53ef\u4ee5\u5e2e\u60a8\u7684\u5417", "\u4e13\u4e1a\u8001\u5e08\u4e00\u5bf9\u4e00\u5feb\u901f\u7b54\u7591", "\u6211\u662f\u8001\u5e08\uff0c\u6709\u4ec0\u4e48\u53ef\u4ee5\u5e2e\u60a8\u7684\u5417\uff1f"],
            I = "", S = 0, w = -1, E = 0;
        return exports.getExpGroupId = function () {
            return m
        }, exports.hasShowInvite = 0, exports.isFininshGetPoint = 0, exports.isShowInIconUp = !1, exports.isUseSmartyInvite = 0, exports.init = function (i, c, m) {
            var p = i.getServer("configBox");
            if (!e()) return !1;
            if (1 !== p.inviteBox.smartBoxEnable || 0 === p.inviteBox.smartBoxOpen) return !1;
            if (o(p)) u(p), exports.isShowInIconUp = s(p.seekIcon), exports.isShowRight = a(p.seekIcon), exports.isShowWithIcon = 1; else if (r(p)) {
                if (exports.isShowWithToolbar = 1, p.toolbar.bottomDistance < 50) exports.isShowInIconUp = !0
            } else return !1;
            if (exports.isUseSmartyInvite = 1, exports.isHideInvite = 0, l = t("word", d), f = t("link", d), !l && !f) return !1;
            n(l, f)
        }, exports.getSmartInviteClass = function () {
            if (1 === exports.isShowWithToolbar) return "nb-invite-wrap-smartInvite-" + S + "-" + w; else return "nb-invite-wrap-smartInvite-" + b
        }, exports.hideInvite = function (e) {
            exports.isHideInvite = 1
        }, exports.getSmartInviteText = function (e) {
            if (g.length > 0) {
                var t = i(), n = Math.floor(Math.random() * y.length);
                return y[n].replace("point", t)
            ...
            if (1 === this.isUseSmartyInvite) {
                ...
                if (e.adata) e.adata.IntelligentInviteMsg = r; else e.adata = {IntelligentInviteMsg: r}
            }
        }, exports.getNowWelcomText = function () {
            return v
        }, exports.getAdata = function () {
            return {IntelligentInviteMsg: v}
        }, exports.getPosition = function () {
            return {invite: I, arrow: E}
        }, exports
    }), define("embed/invite/invitePConfig", ["require", "./inviteMain", "./inviteData", "./inviteHandler", "./pc/invitePMain", "./pc/inviteHandler", "./pc/invitePc.tpl", "./pc/invitePcData", "./pc/inviteConsts", "./mobile/smartyInvite"], function (require) {
        return {
            package: "pinvite",
            resource: {
        ...
        function t(e, t) {
            if ("enable" === t) e.removeClass(n.nodeSendBtn, "message-disable"); else e.addClass(n.nodeSendBtn, "message-disable")
        }

        var exports = {}, n = {}, i = {}, o = !1;
        exports.setVerifyCode = function (e, t, i, o) {
            var r = {bid: t.bid, t: (new Date).getTime()}, s = e.getServer("siteObj"),
                a = s.webRoot + i.GETCODEURL + "?" + o.jsonToQuery(r);
            if (n.nodeVerifyImg) n.nodeVerifyImg.setAttribute("style", "background-image: url(" + a + ")")
        ...
        }, exports.sendMessage = function (e, i, o, r, s, a) {
            var c = e.validateForm(i.g(r.PREFIXNODEID + "form")), u = i.hasClass(n.nodeSendBtn, "message-disable");
            if (c && !u) {
                t(i, "disable");
                for (var d = exports.getExtendNode(), l = i.g(r.PREFIXNODEID + "form"), f = i.getElementsByClass(r.INPUTSELECTOR, l), m = 0; m < f.length; m++) {
                    var p = f[m];
                    if (!p.disabled) if (p.value === p.getAttribute("data-ph")) d[p.name] = ""; else d[p.name] = p.value
                }
                var g = o.urlRoot + r.SAVEURL + "?" + a.jsonToQuery(d),
                    h = {success: exports.sendSucess, failure: exports.sendFail, key: "cb"};
                s.jsonp(g, h)
            }
        }, exports.resetForm = function (e, t) {
            for (var n = e.g(t.PREFIXNODEID + "form"), i = e.getElementsByClass(t.INPUTSELECTOR, n), r = 0; r < i.length; r++) {
                var s = i[r];
                if (!s.disable && s.value !== s.getAttribute("data-ph")) if (o) s.value = s.getAttribute("data-ph"), s.focus(), s.blur(); else s.value = ""
            }
            exports.setVerifyCode()
        }, exports.sendSucess = function (e, i, o) {
            var r = e.getMsgText("success");
            if (0 === o.status) i.show([n.nodeSuccesss]), n.messageTitle.innerHTML = r.title, n.messageContent.innerHTML = r.msg, n.messageBtn.innerHTML = r.btn, exports.resetForm(), i.hide([n.nodeSet, n.nodeSend]); else {
                var r = e.getMsgText("fail");
                i.show([n.nodeSuccesss]), n.messageTitle.innerHTML = r.title, n.messageContent.innerHTML = o.statusInfo || r.msg, n.messageBtn.innerHTML = r.btn, i.hide([n.nodeSet, n.nodeSend]), t(i, "enable")
            }
            t(i, "enable")
        }, exports.sendFail = function (e, i, o) {
            var r = e.getMsgText("fail");
            i.show([n.nodeSuccesss]), n.messageTitle.innerHTML = r.title, n.messageContent.innerHTML = r.msg, i.hide([n.nodeSet, n.nodeSend]), t(i, "enable")
        };
        var r = {height: 0, width: 0};
        return exports.showInCenter = function (t, i) {
            var o = n;
            if (t.show([o.nodeContain]), !o.nodeTool) e(t, i);
            if ("max" === o.nodeTool["data-type"]) exports.showMessage();
            if (!r.width) r.width = o.nodeContain.offsetWidth / 2, r.height = o.nodeContain.offsetHeight / 2;
            t.setStyles(o.nodeContain, {
                top: "50%",
                left: "50%",
                marginLeft: -r.width + "px",
                marginTop: -r.height + "px",
                height: 2 * r.height + "px"
            })
        }, exports.process = function (t, i, r, s) {
            if (e(t, r), n.nodeVerifyImg) exports.setVerifyCode();
            s.registValidate(t.g(r.PREFIXNODEID + "form")), i.init(t.g(r.PREFIXNODEID + "form"));
            var a = document.getElementById("nb-nodeboard-set-content-js");
            if (a && a.value === a.getAttribute("data-ph")) o = !0
        }, exports
        ...
        exports.initSystemInvite = function (e) {
            ...
            var u = o.getServer("siteObj"), d = o.getServer("configBox").inviteBox,
                l = {from: 0, sid: "-100", tid: c || "-1", ttype: 1, siteId: u.siteId, userId: u.userId};
            if (0 !== s) l = {
                from: t.fromType,
                sessionid: t.sid,
                siteId: u.siteId,
            ...
            } else if (!r || r.closed || !r.window) r = window.open(m + "?" + i.jsonToQuery(a), "pcNBBridage", b); else r.focus()
            ...
            if (3 === u.status) c.show([s]), i.sid = u.sid, i.tid = u.tid, i.fromType = 2, i.ttype = 0; else if (4 === u.status) c.hide([s]), i.siteStatus = u.status;
            ...
            if (s) {
                ...
                if (e.siteStatus = a.status, -1 !== "3".indexOf(a.status)) r.show([s]); else r.hide([s]), exports.initSystemInvite()
            }
        ...
        return exports.init = function () {
            if (e.init(t), e.get("log.main").init(), e.get("log.main").logStartNb(), require("cl!../../css/pc/main.css"), !e.get("data.config").getServer("siteObj").isWebim) (0, (false || document.getElementById("newBridge")).require)(["embed/webimlight/main"], function () {
            });
